...
| Perseveration | Drops topics quickly, can't stay focused on anything | "Doesn't dwell," "moves on fast" | Repeats the same arguments, can't let go, returns to old issues compulsively | "Really thinks things through," "doesn't forget what matters" |
